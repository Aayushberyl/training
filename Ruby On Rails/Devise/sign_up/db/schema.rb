...
ActiveRecord::Schema.define(version: 2021_07_20_051120) do
  ...
  create_table "log_ins", force: :cascade do |t|
    ...
    t.string "provider"
    t.string "uid"
    t.index ["email"], name: "index_log_ins_on_email", unique: true
    t.index ["reset_password_token"], name: "index_log_ins_on_reset_password_token", unique: true
  end
