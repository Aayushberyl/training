...
class FlightsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create flight" do
    assert_difference('Flight.count') do
      post flights_url, params: { flight: { body: @flight.body, image: @flight.image, title: @flight.title } }
    end
  ...
  test "should update flight" do
    patch flight_url(@flight), params: { flight: { body: @flight.body, image: @flight.image, title: @flight.title } }
